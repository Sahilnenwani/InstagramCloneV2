                   ...
                   {/* <i className="material-icons" style={{color:"red"}}>favorite</i> */}
                   
                    {
                        ...
                        ? 
                         ...
                         <i className="material-icons" onClick={()=>unlikePost(item._id)} style={{color:"red",cursor: "pointer",fontSize:"2.5em"}}>favorite</i>
                         :
                         <i className="material-icons" onClick={()=>likePost(item._id)} style={{color:"red",cursor: "pointer",fontSize:"2.5em"}}>favorite_border</i>
